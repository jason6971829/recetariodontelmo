...
export const UNITS = [
  ...
  { id: "LITRO", label: "Litro (lt)" },
  { id: "ML", label: "Mililitros (ml)" },
  { id: "UNIDAD", label: "Unidad (und)" },
  { id: "LIBRA", label: "Libra (lb)" },
  { id: "ONZA", label: "Onza (oz)" },
  { id: "PORCION", label: "Porción" },
];

export const SUPPLY_CATEGORIES = [
  "Carnes", "Pollo", "Pescados", "Lácteos", "Verduras", "Frutas",
  "Granos", "Salsas", "Especias", "Aceites", "Bebidas", "Panadería",
  "Empaques", "Desechables", "Limpieza", "Otros",
];
